...
export class DeliveryDetails {
  constructor(page) {
    ...
    this.streetNameInput = page.locator('[data-qa="delivery-address-street"]');
    ...
    this.savedAddressStreetName = page.locator(
  ...
  fillDetails = async (userAddress) => {
    ...
    await this.streetNameInput.fill(userAddress.street);
  ...
  saveDetails = async () => {
    ...
    expect(await this.savedAddressStreetName.first().innerText()).toBe(
      await this.streetNameInput.inputValue(),
    );
